...
public class UploadCheckBC implements Job {

	private final String CONFIG_PATH = Constant.SQLSCRIPT_CHECKBC;
	...
	protected boolean init() {
		...
		mUT = new UtilTools();
		try {
			mDoc = new SAXReader().read(Constant.DBASE_CONFIG_CHECKBC);
	...
	public static void main(String[] args) throws JobExecutionException,
			DocumentException {
		UploadCheckBC ut = new UploadCheckBC();
		JDBCConn.init();
		ut.execute(null);
	}
}
