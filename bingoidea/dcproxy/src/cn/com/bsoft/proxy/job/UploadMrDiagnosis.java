...
public class UploadMrDiagnosis implements Job {

	private final String CONFIG_PATH = Constant.SQLSCRIPT_BAZD;
	...
	protected boolean init() {
		...
		mUT = new UtilTools();
		try {
			mDoc = new SAXReader().read(Constant.DBASE_CONFIG_BAZD);
	...
	public static void main(String[] args) throws JobExecutionException,
			DocumentException {
		UploadMrDiagnosis ut = new UploadMrDiagnosis();
		JDBCConn.init();
		ut.execute(null);
	}
}
