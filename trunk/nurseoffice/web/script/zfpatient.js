...
function update_page(result) {
	//alert(result);
	var str = "<table id='patienttable'><tr bgcolor=#C5E1EF><td colspan=6  style='height:30px;font-weight:bold;font-size:14px'>居民就诊信息</td></tr><tr bgcolor='#cccccc'><td style='height:30px;font-weight:bold;font-size:14px'>姓名</td><td style='height:30px;font-weight:bold;font-size:14px'>性别</td><td style='height:30px;font-weight:bold;font-size:14px'>科室</td><td style='height:30px;font-weight:bold;font-size:14px'>医生</td><td style='height:30px;font-weight:bold;font-size:14px'> 开方日期</td><td style='height:30px;font-weight:bold;font-size:14px'>详细</td></tr>";
...
function prevpage(result) {
	// alert("lastpage");
	var str ="<table id='patienttable'><tr bgcolor=#C5E1EF><td colspan=6 style='height:30px;font-weight:bold;font-size:14px'>居民就诊信息</td></tr><tr bgcolor='#cccccc'><td style='height:30px;font-weight:bold;font-size:14px'>姓名</td><td style='height:30px;font-weight:bold;font-size:14px'>性别</td><td style='height:30px;font-weight:bold;font-size:14px'>科室</td><td style='height:30px;font-weight:bold;font-size:14px'>医生</td><td style='height:30px;font-weight:bold;font-size:14px'>开方日期</td><td style='height:30px;font-weight:bold;font-size:14px'>详细</td></tr>";	var jsonArray = eval("(" + result + ")");
	var from;
	var to;
	var totalPages = 1;
