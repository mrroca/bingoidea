...
//		}
		var c = "";
		if($.url.param("czmc") == "4" || $.url.param("czmc") == 4){
			c = "抽血"
		} else if($.url.param("czmc") == "5" || $.url.param("czmc") == 5){
			c = "取样"
		}else if($.url.param("czmc") == "6" || $.url.param("czmc") == 6){
			c = "测血糖"
		}else if($.url.param("czmc") == "99" || $.url.param("czmc") == 99){
			c = "其他"
		}
