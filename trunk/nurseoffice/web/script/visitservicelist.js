...
$(document).ready(function() {
	$("#clicktable").hide();
	$.ajax( {
		url : "requestVisitService.action",
		type : "post",
		dataType : "json",
		success : update_page
	});
...
function update_page(result) {
	...
	str += "<tr bgcolor=#C5E1EF><td colspan=8  style='height:30px;font-weight:bold;font-size:14px'>医生上门服务信息</td></tr>";
	str += "<tr bgcolor=#99ccff><td colspan=8  style='' align=left>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='visitserviceyuyue.jsp'>预约登记</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='visitserviceyuyuelist.html'>预约列表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='yuyueprintpage.html'>打印今日预约单</a></td></tr>";
	str += "<tr bgcolor='#cccccc'><td style='height:30px;font-weight:bold;font-size:14px'>姓名</td><td style='height:30px;font-weight:bold;font-size:14px'>性别</td><td style='height:30px;font-weight:bold;font-size:14px'>家庭住址</td><td style='height:30px;font-weight:bold;font-size:14px'>联系电话</td><td style='height:30px;font-weight:bold;font-size:14px'>服务医生</td><td style='height:30px;font-weight:bold;font-size:14px'> 上门日期</td><td style='height:30px;font-weight:bold;font-size:14px'>分类</td><td style='height:30px;font-weight:bold;font-size:14px'>详细</td></tr>";
	...
	for ( var one = 0; one < firstpage; one++) {
		...
		str += "<tr bgcolor="
				+ color
				+ "  onClick=\"mclick(this,'"+color+"','"+jsonArray[one].id+"')\" ondblclick=\"mdbclick('"
				+ jsonArray[one].id + "')\"><td>" + jsonArray[one].name
				+ "</td><td>" + s + "</td>";
		str += "<td>" + jsonArray[one].address + "</td><td>"
				+ jsonArray[one].phone + "</td><td>" + jsonArray[one].optuser
				+ "</td>";
		str += "<td>" + jsonArray[one].markdate + "</td>";
		str += "<td>" + kind + "</td>";
...
function mdbclick(id) {
	location.href = "visitserviceluru.jsp?id=" + id + "&flag=1";
}
