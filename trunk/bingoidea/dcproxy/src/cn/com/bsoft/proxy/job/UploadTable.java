...
public class UploadTable implements Job {

	private final String CONFIG_PATH = Constant.SQLSCRIPT_YSPB;
	...
	public UploadTable() {
		...
		mCe = ConditionEntity.getInstance("UT");
	}
	...
	protected boolean init() {
		...
		mUT = new UtilTools();
		try {
			mDoc = new SAXReader().read(Constant.DBASE_CONFIG_YSPB);
	...
	public static void main(String[] args) throws JobExecutionException,
			DocumentException {
		UploadTable ut = new UploadTable();
		JDBCConn.init();
		ut.execute(null);
	}
}
