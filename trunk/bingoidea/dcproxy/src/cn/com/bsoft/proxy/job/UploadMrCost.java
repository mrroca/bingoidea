...
public class UploadMrCost implements Job {

	private final String CONFIG_PATH = Constant.SQLSCRIPT_BACOST;
	...
	public UploadMrCost() {
		...
		mCe = ConditionEntity.getInstance("BACOST");
	}
	...
	protected boolean init() {
		...
		mUT = new UtilTools();
		try {
			mDoc = new SAXReader().read(Constant.DBASE_CONFIG_BACOST);
	...
	public static void main(String[] args) throws JobExecutionException,
			DocumentException {
		UploadMrCost ut = new UploadMrCost();
		JDBCConn.init();
		ut.execute(null);
	}
}
