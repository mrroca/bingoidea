...
public class SimpleHttpServer implements Runnable
{
                ...
                if (client != null)
                {
                    ...
                    try
                    {
                        ...
                        String resource = line.substring(line.indexOf('/'),
                            line.lastIndexOf('/') - 5);
                        // 获得请求的资源的地址
                        resource = URLDecoder.decode(resource, "GB2312");// 反编码
                                                                        // URL
                                                                        // 地址
                        ...
                        else
                        {
                            ...
                            out
                                .println("这是一个支持虚拟路径的图片:<img src='w.jpg'><br>"
                                        + "<a href='w.jpg'>点击打开w.jpg, 是个服务器虚拟路径的图片文件.</a>");
                            out
                                .println("<br>这是个会反馈 404 错误的的图片:<img src='w.jpg'><br><a href='w.jpg'>点击打开w.jpg</a><br>");
                            out
                                .println("<form method=post action='/'>POST 表单 <input name=username value='用户'> <input name=submit type=submit value=submit></form>");
                            out.close();
    ...
    {
        System.out
            .println("Usage: java SimpleHttpServer <port>\nDefault port is 80.");
    }
